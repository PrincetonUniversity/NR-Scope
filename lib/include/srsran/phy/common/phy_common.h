...
#define SRSRAN_CP_NORM_NSYMB_NR 14  // added by Haoran
...
#define SRSRAN_CP_EXT_NSYMB_NR 12   // added by Haoran
...
#define SRSRAN_CP_NSYMB_NR(cp) (SRSRAN_CP_ISNORM(cp) ? SRSRAN_CP_NORM_NSYMB_NR : SRSRAN_CP_EXT_NSYMB_NR)  // added by Haoran
...
#define SRSRAN_CP_LEN_NORM_NR(symbol_sz) ((int)floorf((float)symbol_sz * 0.07034648f)) // added by Haoran
#define SRSRAN_CP_LEN_EXT_NR(symbol_sz) ((int)ceilf((float)symbol_sz * 0.24775045f)) // added by Haoran, only when the scs_idx == 2
...
#define SRSRAN_SLOT_LEN_NR(symbol_sz) (symbol_sz * 30 / 2)    // added by Haoran
#define SRSRAN_SF_LEN(symbol_sz) (symbol_sz * 15)
#define SRSRAN_SF_LEN_MAX (SRSRAN_SF_LEN(SRSRAN_SYMBOL_SZ_MAX))
#define SRSRAN_SF_LEN_NR(symbol_sz, scs_idx) (SRSRAN_SLOT_LEN_NR(symbol_sz) * pow(2, scs_idx))    // added by Haoran
